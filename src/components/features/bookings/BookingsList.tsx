...
export default function BookingsList({ bookings, userName }: BookingsListProps) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-brand-light-gray max-w-3xl mx-auto">
            Welcome, {userName}! View and manage your upcoming wellness appointments and consultations.
          </p>
        </div>
